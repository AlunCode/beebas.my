...
const PROVIDERS: { id: Provider; label: string; icon: React.ReactNode; className: string }[] = [
  {
    ...
    icon: <GoogleIcon />,
    className: 'bg-white hover:bg-gray-50 text-[#1C1C1C] border border-gray-200',
  },
    ...
    <div className="space-y-3">
      ...
      {PROVIDERS.map(p => (
        <button
          ...
          className={`w-full h-11 rounded-xl font-semibold text-sm flex items-center justify-center gap-2.5 transition-colors disabled:opacity-60 ${p.className}`}
        >
