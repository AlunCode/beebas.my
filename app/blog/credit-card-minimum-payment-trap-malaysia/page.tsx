...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'The Minimum Payment Trap' },
  ],
}
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="mt-14 rounded-2xl bg-[#1C1C1C] px-6 py-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <LinkButton href="/#calculator" className="rounded-xl bg-[#FFD000] hover:bg-[#f0c400] text-[#1C1C1C] font-bold border-0 shadow-none px-8 h-11">
                Try the free calculator →
              </LinkButton>
            <LinkButton href="/signup" variant="outline" className="rounded-xl border-white/20 text-white/70 hover:bg-white/10 hover:text-white bg-transparent font-bold h-11 px-8">
